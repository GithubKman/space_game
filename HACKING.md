...
hidden if the `space_game_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `space_game_DEVELOPER_MODE` to the configure
...
Runs the executable target `space_game_exe`.
